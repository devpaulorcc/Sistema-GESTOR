...
var defaultTheme = {
  ...
  borderColor: (theme2) => __assign(__assign({}, theme2("colors")), {
  ...
  height: (theme2) => __assign(__assign(__assign({
    auto: "auto"
  }, theme2("spacing")), ratios(2, 6)), {
    full: "100%",
    screen: "100vh"
  }),
  inset: (theme2) => __assign(__assign(__assign({
    auto: "auto"
  ...
  margin: (theme2) => __assign({
    auto: "auto"
  }, theme2("spacing")),
  maxHeight: (theme2) => __assign(__assign({}, theme2("spacing")), {
    full: "100%",
    screen: "100vh"
  }),
  maxWidth: (theme2, {breakpoints}) => __assign({
    none: "none",
    0: "0rem",
    xs: "20rem",
    sm: "24rem",
  ...
  transitionDuration: (theme2) => __assign({
    DEFAULT: "150ms"
  }, theme2("durations")),
  ...
  translate: (theme2) => __assign(__assign(__assign({}, theme2("spacing")), ratios(2, 4)), {
    full: "100%"
  }),
  width: (theme2) => __assign(__assign(__assign(__assign({
    auto: "auto"
...
var makeThemeResolver = (config) => {
  const cache = new Map();
  const theme2 = __assign(__assign({}, defaultTheme), config);
  ...
  const resolve = (section, key, defaultValue) => {
    ...
    if (!base) {
      cache.set(section, base = __assign({}, deref(theme2, section)));
...
var serialize = (prefix, variants, context) => {
  ...
  const stringify2 = (atRules, selector, presedence, css, important) => {
    ...
    if (css["@apply"]) {
      css = merge(evalThunk(apply(css["@apply"]), context), __assign(__assign({}, css), {"@apply": void 0}), context);
    }
...
var configure = (config = {}) => {
  ...
  if (preflight) {
    ...
    const styles = serialize2(typeof preflight == "function" ? evalThunk(preflight(css, context), context) || css : __assign(__assign({}, css), preflight));
